...
async function main() {
  try {
    ...
    console.log("[✅] Create category mouse and product");
    ...
    console.log("[✅] Create category keyborards and product");
    ...
    console.log("[✅] Create category Headphones and product");
    ...
    console.log("[✅] Create category mousepads and product");
    ...
    console.log("[✅] Create category monitors and product");
    ...
    console.log("[✅] Create category speakers and product");
